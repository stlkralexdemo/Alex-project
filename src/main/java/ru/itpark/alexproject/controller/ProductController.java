...
public class ProductController {
    ...
    @GetMapping(value = "/search", params = "height")
    ...
    @GetMapping(value = "/searchRoad", params = "height")
    ...
    @GetMapping(value = "/searchClassic", params = "height")
    ...
    @GetMapping(value = "/searchSkate", params = "height")
